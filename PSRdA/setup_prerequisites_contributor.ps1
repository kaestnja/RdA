...
if (Test-Path "$temppath") {
	...
	$vsconfig_vs_buildtools_2019 = 	"--add Microsoft.VisualStudio.Workload.MSBuildTools", "--add Microsoft.VisualStudio.Workload.VCTools",
	...
	$vsconfig_vs_enterprise_2019 = 	"--add Microsoft.VisualStudio.Workload.CoreEditor","--add Microsoft.VisualStudio.Workload.VCTools","--add Microsoft.VisualStudio.Workload.Python","--add Microsoft.VisualStudio.Workload.NativeDesktop",
	"--add Microsoft.Component.MSBuild","--add Microsoft.Component.PythonTools","--add Microsoft.Component.PythonTools.Web",
	"--add Microsoft.VisualStudio.Component.Roslyn.Compiler","Microsoft.VisualStudio.Component.CoreEditor",
    "--add Microsoft.VisualStudio.Component.CoreBuildTools",
    "--add Microsoft.VisualStudio.Component.Windows10SDK",
    "--add Microsoft.VisualStudio.Component.VC.CoreBuildTools",
    "--add Microsoft.VisualStudio.Component.VC.Tools.x86.x64",
